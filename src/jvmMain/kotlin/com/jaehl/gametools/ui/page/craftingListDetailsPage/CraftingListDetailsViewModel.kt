...
class CraftingListDetailsViewModel @Inject constructor(
    ...
    private lateinit var craftingListId : String

    fun init(viewModelScope: CoroutineScope, craftingListId : String) {
